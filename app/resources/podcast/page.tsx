  ...
  return (
    <main className="min-h-screen bg-white text-[#3f484f]">
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-32 md:py-48">
          <div className="max-w-3xl">
            <h1 className="text-4xl font-light leading-tight md:text-5xl">
              UNSCRIPTED: Change Management @ Work
            </h1>
            <p className="mt-8 text-base leading-7 md:text-lg">
              Explore real-world insights and conversations about change management with industry experts and thought leaders.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-6 py-28 text-center">
        ...
        <p className="mt-6 text-lg text-gray-700">Episodes and updates will be available here. Stay tuned for the latest discussions on change management.</p>
        <div className="mt-8">
