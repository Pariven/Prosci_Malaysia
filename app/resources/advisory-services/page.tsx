  ...
  return (
    <main className="min-h-screen bg-white text-[#3f484f]">
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-32 md:py-48">
          <div className="max-w-3xl">
            ...
            <p className="mt-8 text-base leading-7 md:text-lg">
              Expert consulting and strategic guidance to accelerate your organizational change initiatives.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-6 py-28 text-center">
        ...
        <p className="mt-6 text-lg text-gray-700">Learn more about our Advisory Services offerings. Details coming soon. Contact us to discuss your specific needs.</p>
        <div className="mt-8">
