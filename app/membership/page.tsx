  ...
  return (
    <main className="min-h-screen bg-white text-[#3f484f]">
      ...
      <section
        ...
        style={{
          backgroundImage: `url('/images/erp-transformation.png')`,
      ...
      >
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-32 md:py-48">
          <div className="max-w-3xl">
            <h1 className="text-4xl font-light leading-tight md:text-5xl">Membership</h1>
            <p className="mt-8 text-base leading-7 md:text-lg">
              Exclusive resources and community access for members.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-6 py-28 text-center">
        ...
        <p className="mt-6 text-lg text-gray-700">Membership details and enrollment information are coming soon. Contact us for early access.</p>
        <div className="mt-8">
